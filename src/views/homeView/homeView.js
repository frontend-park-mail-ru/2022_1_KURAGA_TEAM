export default function template(locals) {
    ...
    (function (items) {
        ...
        pug_mixins["homeView"] = pug_interp = function (items) {
            ...
            pug_html = pug_html + pug_indent.join("");
            pug_html = pug_html + "\u003Cdiv class=\"navbar font\"\u003E" + (null == (pug_interp = items.header) ? "" : pug_interp) + "\u003C\u002Fdiv\u003E\n  ";
            pug_html = pug_html + pug_indent.join("");
            pug_html = pug_html + "\u003Cdiv class=\"mainMovie\"\u003E" + (null == (pug_interp = items.mainMovie) ? "" : pug_interp) + "\u003C\u002Fdiv\u003E\n";
            pug_html = pug_html + pug_indent.join("");
            ...
            pug_html = pug_html + pug_indent.join("");
            pug_html = pug_html + "\u003Cdiv class=\"selectTitle\"\u003EПопулярное\u003C\u002Fdiv\u003E\n    ";
            pug_html = pug_html + pug_indent.join("");
            pug_html = pug_html + "\u003Cdiv class=\"wrap\"\u003E" + (null == (pug_interp = items.carouselPop) ? "" : pug_interp) + "\u003C\u002Fdiv\u003E\n    ";
            pug_html = pug_html + pug_indent.join("");
            pug_html = pug_html + "\u003Cdiv class=\"selectTitle\"\u003EЛучшее за 2021 год\u003C\u002Fdiv\u003E\n    ";
            pug_html = pug_html + pug_indent.join("");
            pug_html = pug_html + "\u003Cdiv class=\"wrap\"\u003E" + (null == (pug_interp = items.carouselTop) ? "" : pug_interp) + "\u003C\u002Fdiv\u003E\n    ";
            pug_html = pug_html + pug_indent.join("");
            pug_html = pug_html + "\u003Cdiv class=\"selectTitle\"\u003EСемейное\u003C\u002Fdiv\u003E\n    ";
            pug_html = pug_html + pug_indent.join("");
