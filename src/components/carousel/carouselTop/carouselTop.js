...
export default function template(locals) {
    ...
    (function (items) {
        items = locals;
        var pug_indent = [];
        pug_mixins["carouselTop"] = pug_interp = function (items) {
                        ...
                        ;(function () {
                            ...
                            if ('number' == typeof $$obj.length) {
                                for (var pug_index1 = 0, $$l = $$obj.length; pug_index1 < $$l; pug_index1++) {
                                    ...
                                    pug_html = pug_html + "\n      ";
                                    pug_html = pug_html + pug_indent.join("");
                                    pug_html = pug_html + "\u003Cdiv class=\"movie-top\"\u003E\u003Ca" + (pug_attr("href", item.href, true, false)) + "\u003E\n          ";
                                    pug_html = pug_html + pug_indent.join("");
                                    pug_html = pug_html + "\u003Cdiv class=\"ref-mov\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fa\u003E\n        ";
                                    pug_html = pug_html + pug_indent.join("");
                                    pug_html = pug_html + "\u003Cdiv class=\"desc-mov-top\"\u003E\n          ";
                                    pug_html = pug_html + pug_indent.join("");
