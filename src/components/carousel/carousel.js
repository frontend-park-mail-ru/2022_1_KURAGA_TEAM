...
export default function carouselTemplate(...locals) {
    ...
    (function (Array, car, items, nextBtn, num, prevBtn, typeMov, wrapMov) {
        ...
        pug_mixins["carousel"] = pug_interp = function (items, car, prevBtn, nextBtn, wrapMov, typeMov, num) {
            ...
            pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["b-carousel", car], [false, true]), false, false)) + "\u003E\u003Cbutton" + (pug_attr("class", pug_classes([`b-carousel` + `${typeMov}` + `__prev ${prevBtn}`], [true]), false, false)) + "\u003E❬\u003C\u002Fbutton\u003E\u003Cbutton" + (pug_attr("class", pug_classes([`b-carousel` + `${typeMov}` + `__next ${nextBtn}`], [true]), false, false)) + "\u003E❭\u003C\u002Fbutton\u003E\u003Cdiv" + (pug_attr("class", pug_classes([`b-carousel` + `${typeMov}` + `__wrap ${wrapMov}`], [true]), false, false) + " style=\"transform: translateX(0%);\"") + "\u003E";
// iterate Array(num)
            ;(function () {
                var $$obj = Array(num);
                        ...
                        ;(function () {
                            ...
                            if ('number' == typeof $$obj.length) {
                                for (var pug_index1 = 0, $$l = $$obj.length; pug_index1 < $$l; pug_index1++) {
                                    ...
                                    pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes([`movie` + `${typeMov}`], [true]), false, false) + " style=\"background: url(..\u002F..\u002F..\u002Fstatic\u002Fstar.png);background-size: contain;\"") + "\u003E\u003Ca" + (pug_attr("href", item.href, true, false)) + "\u003E\u003Cdiv class=\"ref-mov\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fa\u003E\u003Cdiv" + (pug_attr("class", pug_classes([`desc-mov` + `${typeMov}`], [true]), false, false)) + "\u003E\u003Cdiv\u003E" + (pug_escape(null == (pug_interp = item.name) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"genre\"\u003E" + (pug_escape(null == (pug_interp = item.genre) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003Cinput class=\"input-like\" id=\"cb\" type=\"checkbox\"\u002F\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
                                }
                            } else {
                                var $$l = 0;
